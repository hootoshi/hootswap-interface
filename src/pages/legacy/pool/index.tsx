...
import { CurrencyAmount } from 'app/config/core-sdk'
  ...
  return (
    <>
      ...
      <SwapLayoutCard className="!bg-dark-900 border border-dark-800 !p-0 overflow-hidden">
        {!account ? (
          <Web3Connect className="w-full !bg-dark-900 bg-gradient-to-r from-purple-600 to-gold-600 hover:from-purple/80 hover:to-gold-600/80 focus:from-purple/80 focus:to-gold-600/80 active:from-purple/70 active:to-gold-600/70 text-white h-[38px] shadow-liquidity" />
        ) : (

...
import { Currency, CurrencyAmount, JSBI, NATIVE, Token } from 'app/config/core-sdk'
  ...
  return (
    <Container id="find-pool-page" className="py-4 mx-auto space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      ...
      <Alert
        ...
        type="information"
      />
      <div className="relative p-4 space-y-4 rbg-gradient-to-r from-purple-600 to-gold-600 hover:from-purple/80 hover:to-gold-600/80 focus:from-purple/80 focus:to-gold-600/80 active:from-purple/70 active:to-gold-600/70 shadow-liquidity">
        <AutoColumn gap={'md'}>
          <CurrencySelectPanel
            currency={currency0}

import { ChainId, Currency, WNATIVE } from 'app/config/core-sdk'
...
const QomLogo =
  'https://raw.githubusercontent.com/RobotMasterxo/test-swap-interfacev2/main/src/assets/images/qom-logo.png'

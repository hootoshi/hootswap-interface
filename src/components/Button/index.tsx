...
export type ButtonColor = 'red' | 'blue' | 'pink' | 'purple' | 'gradient' | 'gray' | 'gold' | 'darkgold'
...
const FILLED = {
  ...
  blue: '!bg-gradient-to-r from-purple-600 to-gold-600 hover:from-purple/80 hover:to-gold-600/80 focus:from-purple/80 focus:to-gold-600/80 active:from-purple/70 active:to-gold-600/70', //connect to wallet unconnected
  red: 'bg-red',
  pink: 'bg-gold',
  purple: 'bg-purple',
  gold: 'bg-gold',
  black: 'bg-black',
  darkgold: 'bg-darkgold',
  // ENTER AN AMOUNT SWAP BOX
  gradient:
    '!bg-gradient-to-r from-purple-600 to-gold-600 hover:from-purple/80 hover:to-gold-600/80 focus:from-purple/80 focus:to-gold-600/80 active:from-purple/70 active:to-gold-600/70 shadow-liquidity',
  gray: 'bg-dark-700',
}
...
const OUTLINED = {
  ...
  gradient: 'border-none !bg-gold to-black-1000 hover:from-gold/80 hover:to-black-600/80 focus:from-blue/80 focus:to-pink-600/80 active:from-blue/70 active:to-pink-600/70',
...
const EMPTY = {
  ...
  black: 'text-black',
  gradient:
  '!bg-gradient-to-r from-gold to-black-1000 hover:from-gold/80 hover:to-black-600/80 focus:from-blue/80 focus:to-pink-600/80 active:from-blue/70 active:to-pink-600/70',
}

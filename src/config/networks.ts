...
const QOM = 'https://raw.githubusercontent.com/RobotMasterxo/test-swap-interfacev2/main/src/assets/images/qom-logo.png'
...
export const NETWORK_LABEL: Record<number, string> = {
  ...
  [ChainId.BSC]: 'BSC',
  [ChainId.BSC_TESTNET]: 'QOM Testnet',

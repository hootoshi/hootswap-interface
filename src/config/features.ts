...
const features: FeatureMap = {
  ...
  [ChainId.FANTOM]: [Feature.AMM, Feature.LIQUIDITY_MINING, Feature.MISO, Feature.SUBGRAPH],
  ...
  [ChainId.AVALANCHE]: [Feature.AMM, Feature.KASHI, Feature.MISO, Feature.SUBGRAPH],
  [ChainId.AVALANCHE_TESTNET]: [Feature.AMM],
  [ChainId.OKEX]: [Feature.AMM],
  [ChainId.OKEX_TESTNET]: [Feature.AMM],
  [ChainId.XDAI]: [Feature.AMM, Feature.LIQUIDITY_MINING, Feature.KASHI, Feature.SUBGRAPH],
  ...
  [ChainId.ARBITRUM]: [Feature.AMM, Feature.LIQUIDITY_MINING, Feature.KASHI, Feature.MISO, Feature.SUBGRAPH],
  [ChainId.FUSE]: [Feature.AMM, Feature.LIQUIDITY_MINING, Feature.SUBGRAPH],

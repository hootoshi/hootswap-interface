...
export function useSwapActionHandlers(): {
  ...
  const outputCurrencyId = router.query.outputCurrency
...
const BAD_RECIPIENT_ADDRESSES: { [chainId: string]: { [address: string]: true } } = {
  [ChainId.ETHEREUM]: {
    '0x1Ffec29414E83Cd5A97a6727c4F8d7fC5cf9f861': true, // v2 factory
    '0x2D91dd9EeC5E45cac44432BFE4fc9bDed308293f': true, // v2 router 02
  },
}
